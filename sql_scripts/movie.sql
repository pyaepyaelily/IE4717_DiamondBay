...
(2, 'Talk to me', 'movie_talktome.png', 'Advance Sales', '1h 35m', 'NC 16', 'When a group of friends discover how to conjure spirits with an embalmed hand, they become hooked on the new thrill and high-stakes party game -- until one of them goes too far and unleashes terrifying supernatural forces.', ''),
(7, 'Elemental', 'movie_elemental.png', 'Now Showing', '1h 42m', 'PG 13', 'In a city where fire, water, land, and air residents live together, a fiery young woman and a go-with-the-flow guy discover something elemental: how much they actually have in common.', ''),
...
(9, 'Leo:Bloody Sweet', 'movie_leo.png', 'Advance Sales', '2h 44m', 'NC 16', 'The film follows Parthi, a café owner \r\nand animal rescuer in Theog, who is pursued by gangsters Antony and Harold Das who suspect him to be Antony\'s estranged son, Leo.', ''),
...
(11, 'Ballerina', 'movie_ballerina.png', 'Now Showing', '1h 33m', 'PG 13', 'Grieving the loss of a best friend she could not protect, former bodyguard Ok-ju sets out to fulfil her dear friend\'s last wish: sweet, sweet revenge.', ''),
(12, 'The Nun II', 'movie_thenun.png', 'Now Showing', '1h 50m', 'NC 16', 'In 1956 France, a priest is violently murdered, and Sister Irene begins to investigate. She once again comes face-to-face with a powerful evil.', ''),
(13, 'Foe', 'movie_foe', 'Advance Sales', '1h 48m', 'PG 13', 'Hen and Junior\'s quiet life is thrown into turmoil when an uninvited stranger shows up at their door with a startling proposal.', ''),
